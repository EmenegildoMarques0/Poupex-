                    ...
                    <div className="flex flex-1 items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Aula {lesson.data.order} de {course.data.lessons?.length ?? 0}
                            </p>
                        </div>
                    </div>
                </div>
                                ...
                                <Card className="p-6">
                                    {lesson.data.supporting_materials && lesson.data.supporting_materials.length > 0 ? (
                                        <div className="space-y-3">
                                            {lesson.data.supporting_materials.map((material, index) => (
                                                <div
                                                    key={index}
                ...
                <aside className="w-full border-l bg-muted/30 lg:w-[380px]">
                    <div className="sticky top-16">
                        <div className="border-b bg-background p-4">
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">{course.data.lessons?.length ?? 0} aulas disponíveis</p>
                        </div>

                        <div className="max-h-[calc(100vh-12rem)] overflow-y-auto">
                            {course.data.lessons?.map((lessonItem, index) => {
